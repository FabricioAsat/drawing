...
export const SDraw = ({
  ...
  const [currentSetting, setcurrentSetting] = useState<TPen>();
  const { getPenById, updatePenInfo } = useShapeContext();

  function handleCurrentSetting(attr: string, value: string | number) {
    if (attr === "strokeWidth" || attr === "strokeColor") {
      setInitialDrawProps({ ...initialDrawProps, [attr]: value });
    }
  ...
  useEffect(() => {
    ...
    setcurrentSetting(getPenById(selectedShape.id));
  }, [selectedShape]);

  useEffect(() => {
    if (!currentSetting || !selectedShape) return;
    updatePenInfo(currentSetting);
  }, [currentSetting]);
        ...
        <div className="flex items-center my-px gap-x-2">
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeColor === "#262626"
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
          ...
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeColor === "#38bdf8"
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
          ...
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeColor === "#f87171"
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
          ...
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeColor === "#4ade80"
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
          ...
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeColor === "#f472b6"
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
        ...
        <div className="flex items-center my-px gap-x-2">
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeWidth === 3
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
          ...
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeWidth === 6
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
          ...
          <button
            ...
            className={`p-px border rounded-md hover:border-neutral-300 ${
              ...
              initialDrawProps.strokeWidth === 9
                ? "border-neutral-800"
                : "border-transparent"
            }`}
          >
